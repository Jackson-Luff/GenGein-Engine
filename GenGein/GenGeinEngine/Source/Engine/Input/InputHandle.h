...
namespace Input
{
	...
	{
	public:
		static bool isKeyUp(const int a_keyType);
		static bool isKeyDown(const int a_keyType);
		static bool isKeyRelease(const int a_keyType);

		static void RunDebugControls();
	};
	...
	public:
		...
		static glm::dvec2 GetOldCursorPos();
		static void SetCursorPos(const double a_X, const double a_Y);
	private:
		static glm::dvec2 m_oldCursorPos;
	};
